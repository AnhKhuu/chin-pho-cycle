...
export const Header = () => {
  ...
  const routes = [
    {
      href: AdminRouteTypes.BRAND_PAGE,
      label: 'Brands',
      active: pathname.startsWith(AdminRouteTypes.BRAND_PAGE),
    },
    {
      href: AdminRouteTypes.CATEGORY_PAGE,
      label: 'Categories',
      active: pathname.startsWith(AdminRouteTypes.CATEGORY_PAGE),
    },
  ];
