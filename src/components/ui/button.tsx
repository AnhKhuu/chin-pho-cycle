...
const buttonVariants = cva(
  'inline-flex items-center justify-center font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded',
  {
    variants: {
      variant: {
        default:
          'transition ease-in-out duration-300 bg-primary text-white hover:bg-opacity-90',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-white text-white px-16 py-5 font-semibold hover:bg-white hover:text-primary',
        secondary:
          'bg-white text-black-foreground hover:bg-gray-300 transition ease-in-out duration-300 ',
