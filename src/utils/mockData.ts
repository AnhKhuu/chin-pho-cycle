export const images = [
  {
    title: 'ALT_ROAD',
    description:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pellentesque scelerisque enim non venenatis. Sed eleifend orci eget diam auctor consequat. Vestibulum blandit, urna id porta faucibus, ligula metus convallis dui.',
...
export const products = [
  ...
  },
  {
    ...
    color: 'Blue',
    imageUrl:
      'https://cdn.shopify.com/s/files/1/2180/3833/products/MAP-MAJ412_ANT.System_20Pro_20Air_20Jersey_Antarctica_PRODUCT_CARD_ALT.jpg?v=1695700127&width=384&quality=65',
    price: '100,000,000',
    sizes: ['S', 'M', 'L'],
  },
  {
